...
- **Real Lance backend** for the versioned system-of-record (tradebook) —
  versioning / correction lineage / time-travel. Compute table stays our packed
  format; Lance slots behind the same writer/reader interface.
